...
public final class PacketTypes {
    ...
    public static final PacketType PLAY_CLIENT_CRAFT_RECIPE_RESPONSE = of(PLAY, OUTBOUND, 0x2B);
    public static final PacketType PLAY_CLIENT_PLAYER_ABILITIES = of(PLAY, OUTBOUND, 0x2C);
    public static final PacketType PLAY_CLIENT_COMBAT_EVENT = of(PLAY, OUTBOUND, 0x2D);
    public static final PacketType PLAY_CLIENT_PLAYER_LIST_ITEM = of(PLAY, OUTBOUND, 0x2E);
    public static final PacketType PLAY_CLIENT_PLAYER_POSITION_AND_LOOK = of(PLAY, OUTBOUND, 0x2F);
    public static final PacketType PLAY_CLIENT_USE_BED = of(PLAY, OUTBOUND, 0x30);
    public static final PacketType PLAY_CLIENT_UNLOCK_RECIPES = of(PLAY, OUTBOUND, 0x31);
    public static final PacketType PLAY_CLIENT_DESTROY_ENTITIES = of(PLAY, OUTBOUND, 0x32);
    public static final PacketType PLAY_CLIENT_REMOVE_ENTITY_EFFECT = of(PLAY, OUTBOUND, 0x33);
    public static final PacketType PLAY_CLIENT_RESOURCE_PACK_SEND = of(PLAY, OUTBOUND, 0x34);
    public static final PacketType PLAY_CLIENT_RESPAWN = of(PLAY, OUTBOUND, 0x35);
    public static final PacketType PLAY_CLIENT_ENTITY_HEAD_LOOK = of(PLAY, OUTBOUND, 0x36);
    public static final PacketType PLAY_CLIENT_SELECT_ADVANCEMENT_TAB = of(PLAY, OUTBOUND, 0x37);
    public static final PacketType PLAY_CLIENT_WORLD_BORDER = of(PLAY, OUTBOUND, 0x38);
    public static final PacketType PLAY_CLIENT_CAMERA = of(PLAY, OUTBOUND, 0x39);
    public static final PacketType PLAY_CLIENT_HELD_ITEM_CHANGE = of(PLAY, OUTBOUND, 0x3A);
    public static final PacketType PLAY_CLIENT_DISPLAY_SCOREBOARD = of(PLAY, OUTBOUND, 0x3B);
    public static final PacketType PLAY_CLIENT_ENTITY_METADATA = of(PLAY, OUTBOUND, 0x3C);
    public static final PacketType PLAY_CLIENT_ATTACH_ENTITY = of(PLAY, OUTBOUND, 0x3D);
    public static final PacketType PLAY_CLIENT_ENTITY_VELOCITY = of(PLAY, OUTBOUND, 0x3E);
    public static final PacketType PLAY_CLIENT_ENTITY_EQUIPMENT = of(PLAY, OUTBOUND, 0x3F);
    public static final PacketType PLAY_CLIENT_SET_EXPERIENCE = of(PLAY, OUTBOUND, 0x40);
    public static final PacketType PLAY_CLIENT_UPDATE_HEALTH = of(PLAY, OUTBOUND, 0x41);
    public static final PacketType PLAY_CLIENT_SCOREBOARD_OBJECTIVE = of(PLAY, OUTBOUND, 0x42);
    public static final PacketType PLAY_CLIENT_SET_PASSENGERS = of(PLAY, OUTBOUND, 0x43);
    public static final PacketType PLAY_CLIENT_TEAMS = of(PLAY, OUTBOUND, 0x44);
    public static final PacketType PLAY_CLIENT_UPDATE_SCORE = of(PLAY, OUTBOUND, 0x45);
    public static final PacketType PLAY_CLIENT_SPAWN_POSITION = of(PLAY, OUTBOUND, 0x46);
    public static final PacketType PLAY_CLIENT_TIME_UPDATE = of(PLAY, OUTBOUND, 0x47);
    public static final PacketType PLAY_CLIENT_TITLE = of(PLAY, OUTBOUND, 0x48);
    public static final PacketType PLAY_CLIENT_SOUND_EFFECT = of(PLAY, OUTBOUND, 0x49);
    public static final PacketType PLAY_CLIENT_PLAYER_LIST_HEADER_AND_FOOTER = of(PLAY, OUTBOUND, 0x4A);
    public static final PacketType PLAY_CLIENT_COLLECT_ITEM = of(PLAY, OUTBOUND, 0x4B);
    public static final PacketType PLAY_CLIENT_ENTITY_TELEPORT = of(PLAY, OUTBOUND, 0x4C);
    public static final PacketType PLAY_CLIENT_ADVANCEMENTS = of(PLAY, OUTBOUND, 0x4D);
    public static final PacketType PLAY_CLIENT_ENTITY_PROPERTIES = of(PLAY, OUTBOUND, 0x4E);
    public static final PacketType PLAY_CLIENT_ENTITY_EFFECT = of(PLAY, OUTBOUND, 0x4F);
    // Server
    ...
    public static final PacketType PLAY_SERVER_PLAYER = of(PLAY, INBOUND, 0x0C);
    public static final PacketType PLAY_SERVER_PLAYER_POSITION = of(PLAY, INBOUND, 0x0D);
    public static final PacketType PLAY_SERVER_PLAYER_POSITION_AND_LOOK = of(PLAY, INBOUND, 0x0E);
    public static final PacketType PLAY_SERVER_PLAYER_LOOK = of(PLAY, INBOUND, 0x0F);
    ...
    public static final PacketType PLAY_SERVER_CRAFT_RECIPE_REQUEST = of(PLAY, INBOUND, 0x12);
    public static final PacketType PLAY_SERVER_PLAYER_ABILITIES = of(PLAY, INBOUND, 0x13);
    public static final PacketType PLAY_SERVER_PLAYER_DIGGING = of(PLAY, INBOUND, 0x14);
    public static final PacketType PLAY_SERVER_ENTITY_ACTION = of(PLAY, INBOUND, 0x15);
    public static final PacketType PLAY_SERVER_STEER_VEHICLE = of(PLAY, INBOUND, 0x16);
    public static final PacketType PLAY_SERVER_CRAFTING_BOOK_DATA = of(PLAY, INBOUND, 0x17);
    public static final PacketType PLAY_SERVER_RESOURCE_PACK_STATUS = of(PLAY, INBOUND, 0x18);
    public static final PacketType PLAY_SERVER_ADVANCEMENT_TAB = of(PLAY, INBOUND, 0x19);
    public static final PacketType PLAY_SERVER_HELD_ITEM_CHANGE = of(PLAY, INBOUND, 0x1A);
    public static final PacketType PLAY_SERVER_CREATIVE_INVENTORY_ACTION = of(PLAY, INBOUND, 0x1B);
    public static final PacketType PLAY_SERVER_UPDATE_SIGN = of(PLAY, INBOUND, 0x1C);
    public static final PacketType PLAY_SERVER_ANIMATION = of(PLAY, INBOUND, 0x1D);
    public static final PacketType PLAY_SERVER_SPECTATE = of(PLAY, INBOUND, 0x1E);
    public static final PacketType PLAY_SERVER_PLAYER_BLOCK_PLACEMENT = of(PLAY, INBOUND, 0x1F);
    public static final PacketType PLAY_SERVER_USE_ITEM = of(PLAY, INBOUND, 0x20);
